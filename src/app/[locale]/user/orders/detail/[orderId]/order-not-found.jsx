...
export default function OrderNotFound() {
  return (
    <div className="w-full h-screen lg:pl-[300px] flex flex-col justify-start items-center py-10">
      <div className="flex flex-col justify-center items-center text-center">
        ...
        <Link href="/user/orders" className="inline-flex mt-6 bg-black-secondary text-white-secondary px-5 py-2 rounded-md shadow-md hover:bg-black-primary">
