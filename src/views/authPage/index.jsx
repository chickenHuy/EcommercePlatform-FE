...
const AuthPage = () => {
  ...
  const handleFacebookClick = () => {
    const callbackUrl = FacebookOAuthConfig.redirectUri; // URL mà Facebook sẽ gọi sau khi xác thực thành công
    const authUrl = FacebookOAuthConfig.authUri; // Facebook OAuth URL
  ...
  return (
    <div className="w-full h-full min-h-screen flex justify-center items-center">
      <div className="w-fit h-fit flex flex-col justify-center items-center lg:flex-row lg:gap-5">
        ...
        <Image
          className="w-full lg:w-[55%] h-fit"
          src={BackgroundAuthPage}
          alt=""
        />
      </div>
    </div>
